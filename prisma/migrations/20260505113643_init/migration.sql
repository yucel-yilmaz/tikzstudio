-- CreateEnum
CREATE TYPE "CompileStatus" AS ENUM ('PENDING', 'RUNNING', 'SUCCESS', 'FAILED', 'TIMEOUT');

-- CreateEnum
CREATE TYPE "LatexEngine" AS ENUM ('TECTONIC', 'PDFLATEX', 'XELATEX', 'LUALATEX');
...
CREATE TABLE "CompileJob" (
    ...
    "engine" "LatexEngine" NOT NULL DEFAULT 'TECTONIC',
    "log" TEXT,
    "outputUrl" TEXT,
    "errorCode" TEXT,
