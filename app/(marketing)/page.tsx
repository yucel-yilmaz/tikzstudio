          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <h1 className="max-w-4xl text-5xl font-semibold leading-tight tracking-tight md:text-6xl">
                TikZ diyagramlarını modern bir editör, güvenli derleme ve canlı PDF akışıyla üret.
              </h1>
              <p className="max-w-2xl text-base leading-7 text-(--ink-1) md:text-lg">
                Araştırma, eğitim ve teknik dokümantasyon ekipleri için tasarlanmış profesyonel bir tarayıcı editörü.
                Kod yaz, derle, günlükleri incele ve PDF çıktısını tek yüzeyde yönet.
              </p>
            </div>
            ...
            <div className="grid gap-3 pt-2 sm:grid-cols-3">
              {[
                ...
                <div key={title} className="rounded-3xl border border-(--line) bg-white/65 p-4">
                  <p className="font-medium">{title}</p>
                  <p className="mt-2 text-sm leading-6 text-(--ink-1)">{description}</p>
                </div>
              ))}
            </div>
          </div>
            ...
            <CardContent className="space-y-5 p-5">
              <div className="flex items-center justify-between">
                <div className="space-y-1">
                  ...
                  <p className="text-xs uppercase tracking-[0.16em] text-[#c9bca7]">Aktif düzenleme</p>
                </div>
                <Badge variant="outline" className="border-[#40352d] bg-[#231d18] text-[#f2e9db]">
                  TECTONIC
                </Badge>
              </div>
...
\end{tikzpicture}`}
              ...
              <div className="grid gap-3">
                {[
                  ...
                  <div key={title} className="rounded-2xl bg-[#211b16] px-4 py-3">
                    <p className="font-medium">{title}</p>
                    <p className="mt-1 text-sm leading-6 text-[#d7c9b5]">{description}</p>
                  </div>
                ))}
              </div>
            </CardContent>
        ...
        {[
          {
            ...
            description: "Kod, derleme ve PDF çıktısını ayrı araçlara bölmeden tek çalışma alanında yönet.",
          },
          {
            icon: ShieldCheck,
            title: "Güvenli derleme sınırı",
            description: "LaTeX yürütmesini ağsız, izole Docker ortamında çalıştırarak risk yüzeyini daralt.",
          },
          {
            icon: Layers3,
            title: "Şablon ve parça kütüphanesi",
            description: "Sık kullanılan blokları ve başlangıç belgelerini birkaç tıklamayla ekle.",
          },
      ...
      <section className="grid gap-4 lg:grid-cols-[1.1fr_0.9fr]">
        <Card>
          <CardContent className="space-y-5 p-6">
            ...
            <div className="space-y-3">
              <h2 className="text-3xl font-semibold">Diyagram kalitesini araç karmaşasına kurban etmek istemeyen ekipler için.</h2>
              <p className="text-sm leading-7 text-(--ink-1)">
                Akademik figürler, teknik şemalar, algoritma akışları ve eğitim içerikleri üreten ekipler için net,
                sade ve üretim odaklı bir TikZ yüzeyi.
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="bg-[color-mix(in_srgb,var(--surface-2)_72%,white_28%)]">
          <CardContent className="space-y-5 p-6">
            ...
            <div className="space-y-3">
              <h2 className="text-2xl font-semibold">Hızlı başlangıç, ciddi görünüm</h2>
              <p className="text-sm leading-7 text-(--ink-1)">
                İlk çizgiden PDF indirmeye kadar geçen süreyi kısaltırken çalışma alanını profesyonel tut.
              </p>
            </div>
